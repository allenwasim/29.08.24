...
class TColors {
  ...
  static Color primary = Color.fromRGBO(61, 219, 195, 1);
  static Color secondary = Color(0xFFFFE24B);
  static Color accent = Color(0xFFb0c7ff);

  static Color textprimary = Color(0xFF333333);
  static Color textsecondary = Color(0xFF272727);
  static Color textWhite = Color(0xFFF3F5FF);
  ...
  static Color warning = Color(0xFFF57300);
  ...
  static Color lightGrey = Color(0xFF);
  static Color white = Colors.white;
  static Color trainerPrimary = const Color(0xFF00796B);
}
